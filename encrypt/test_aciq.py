...
# we avoid calculating MSEs from scratch each time.
# Rather, as N (0, sigma^2) = sigma * N (0, 1)
# and Laplace(0, b) = b * Laplace(0, 1),
# it is sufficient to store the optimal clipping values for N (0, 1)
# and Laplace(0, 1) and scale these
